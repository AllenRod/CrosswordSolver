...
def lcValue (index, vars, constraints, assignments):  
    ...
    #valueConflicts.put((numConflicts, value))
    #lcValues = []
    #lcValue = valueConflicts.get()
    #conflicts = lcValue[0]
    #lcValues.append(lcValue[1])
    #while not valueConflicts.empty():
    #    tempValue = valueConflicts.get()
    #    if tempValue[0] == conflicts:
    #        lcValues.append(tempValue[1])
    #randValue = random.choice(lcValues)
    #return randValue
...
'''
# seed: 798850968554777854, 238597115287715126, 3641709110408317623, 8225449579567215883
index_len = {1:3, 2:1, 3:5, 4:5, 5:1, 6:5, 7:3, 8:3, 9:4, 10:5, 11:3, 12:8, 13:3, 14:4}
...
#assignments ={1:"delve", 2:"lucible"}
#{1: 'mooch', 2: 'ozonify', 3: 'verst', 4: 'mediant'}
#assignments = {1: 'het', 2: 'k', 3: 'kauri', 4: 'batak', 5: 'e', 6: 'nunni', 7: 'gat', 8: 'hub', 9: 'gugu', 10: 'covet', 11: 'jat', 12: 'tiptopsome', 13: 'san', 14: 'kiku'}

#result = has_conflicts(1, constraints, assignments)
#result = goal_check(index_len, constraints, assignments)
#print(result)
...
while randomRestarts > 0:
    ...
    random.seed(8225449579567215883)    
